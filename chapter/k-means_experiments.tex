...
\begin{figure}[h]
    \subfloat[]{\includegraphics[width=0.44\linewidth]{syn-running-time.jpg}}
    \subfloat[]{\includegraphics[width=0.44\linewidth]{syn-sum-squared-distances.jpg}} \\
    \subfloat[]{\includegraphics[width=0.44\linewidth]{real-running-time.jpg}}
    \subfloat[]{\includegraphics[width=0.44\linewidth]{real-sum-squared-distances.jpg}}
...
\begin{figure}[h]
    \subfloat[]{\includegraphics[width=0.44\linewidth]{image-running-time.jpg}}
    \subfloat[]{\includegraphics[width=0.44\linewidth]{image-obj.jpg}}
